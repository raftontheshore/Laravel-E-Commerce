...
<head>
    ...
    <style>
        ...
        .info-value a:hover { color: #c0392b; }
        ...
        .input-wrap:focus-within { border-color: #c0392b; }
        .input-wrap i {
            color: #444;
            font-size: 13px;
            flex-shrink: 0;
        ...
        .btn-contact-submit:hover { background: #e74c3c; }
        ...
        .user-chip-icon i { color: #c0392b; font-size: 16px; }
        .user-chip-label {
            font-size: 11px;
            color: #555;
            letter-spacing: 1px;
            ...
            <div class="contact-card">
                ...
                <div class="info-body">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-text">
                            ...
                            <span class="info-value">Catacumbas S.R.L.</span>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-text">
                            ...
                            <span class="info-value">Carlos Bilardo</span>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-text">
                            ...
                            <span class="info-value">
                                <a href="tel:+5493794246721">+54 379 4246721</a>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-text">
                            ...
                            <span class="info-value">info@catacumbas.com</span>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-text">
                            ...
                            <span class="info-value">123 Calle Y, Corrientes, Argentina</span>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-text">
                            ...
                            <span class="info-value">
                                Lunes a Viernes<br>09:00 a 18:00 hs
                            </span>
                        </div>
                    </div>
                ...
                <div style="padding:16px 20px;border-top:1px solid #1e1e1e;display:flex;gap:10px;justify-content:center;">
                    <a href="https://www.instagram.com/" target="_blank"
                       style="display:flex;align-items:center;gap:6px;font-size:12px;color:#555;text-decoration:none;padding:7px 12px;background:#1a1a1a;border:1px solid #222;border-radius:6px;transition:color 0.15s,border-color 0.15s;"
                    ...
                    <form action="{{ url('/contacto') }}" method="POST">
                        ...
                        @guest
                            ...
                            <div class="form-field">
                                <label for="telefono">
                                    Teléfono
                                    <span style="color:#444;font-size:10px;text-transform:none;letter-spacing:0;">(opcional)</span>
                                </label>
                                <div class="input-wrap">
                                    <i class="bi bi-telephone"></i>
                                    <input type="text" id="telefono" name="telefono"
                                           placeholder="+54 379 xxxxxxx"
                                           value="{{ old('telefono') }}">
                                </div>
                            </div>
                        @endguest

                        {{-- ── AUTH: chip con datos del usuario ── --}}
                        @auth
                            <div class="user-chip">
                                <div class="user-chip-icon">
                                    <i class="bi bi-person-check"></i>
                                </div>
                                <div>
                                    <div class="user-chip-label">Enviando como</div>
                                    <div class="user-chip-name">
                                        {{ auth()->user()->nombre }}
                                        <span>·</span>
                                        <span style="color:#555;">{{ auth()->user()->email }}</span>
                                    </div>
                                </div>
                            </div>
                        @endauth

                        {{-- ── Asunto y Mensaje: siempre visibles ── --}}
                        <div class="form-field">
