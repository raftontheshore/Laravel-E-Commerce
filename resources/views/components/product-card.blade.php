<div class="card border-0 shadow-sm h-100 text-decoration-none" 
     style="min-width: 280px; max-width: 280px; transition: box-shadow 0.3s; cursor: pointer;" 
    ...
    <div class="d-flex align-items-center justify-content-center p-3 border-bottom bg-white" style="height: 220px;">
        <img src="{{ $product->image_url }}" alt="{{ $product->title }}" class="img-fluid" style="max-height: 100%; object-fit: contain;">
    </div>
    ...
    <div class="card-body p-3 d-flex flex-column">
        ...
        <div class="text-dark small mb-2">
            6 cuotas de $ {{ number_format($product->price / 6, 0, ',', '.') }}
        </div>
