{{--
    ============================================================
    COMPONENTE: Barra de Navegación (catacumbas-nav)
    ------------------------------------------------------------
...
<nav class="navbar navbar-expand-lg navbar-dark py-2 catacumbas-nav">
    <div class="container-fluid px-4">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            {{-- Links principales. request()->is() marca el link como
                 'active' si la URL actual coincide con el patrón dado. --}}
            ...
            {{-- Bloque derecho: buscador (comentado) + botones de auth.
